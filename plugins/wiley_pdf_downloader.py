...
class WileyPDFDownloader(BasePlugin):
    ...
    SUPPORTED_PREFIXES = ("10.1002", "10.1111", "10.1113", "10.1046", "10.1034")
    ...
    def build_download_url(self, doi: str) -> Optional[str]:
        """Build a Wiley pdfdirect URL for supported DOI prefixes."""
    ...
    async def download(
        ...
        doi = self.normalize_doi(doi or self.extract_doi(url) or "wiley_download")
